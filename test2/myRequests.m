...
#import "myRequestsCell.h"
#import "myRequestsDetail.h"
...
{
    myRequestsCell *cell = [tableView dequeueReusableCellWithIdentifier:@"myRequestCell"];
    
    if (cell == nil) {
        NSLog(@"cell is Nil");
        cell = [[myRequestsCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"myRequestCell"];
    }
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        ...
        //i need to make a delete script on the PHP side
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    myRequestsDetail *detail = [self.storyboard instantiateViewControllerWithIdentifier:@"myRequestsDetail"];
